...
class BaseTestCase(TestCase):
    ...
    def populate_db(self):
        ...
        data_for_dishes = (Recipe("/static/img/kurica_s_sirom_v_duhovke.webp", "https://povar.ru/recipes/kurica_s_syrom_v_duhovke_jar_ptica-72195.html", "30 мин.", "2 ч.", 1),
                           ...
                           Implement("Духовка"),
                           Implement("Миксер"),
                           StepOfCook(1, "Выпотрошенную тушку курицы промойте под холодной водой, обсушите бумажными полотенцами. Соедините соевый соус, горчицу и растительное масло. Натрите смесью птицу внутри и снаружи. Оставьте мариноваться на 20 минут.", 1),
                           ...
                           Ingredient("Курица", 3, UnitsOfMeasurement.KILOGRAM),
